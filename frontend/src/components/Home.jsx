      ...
      <div className="div">
        <footer className="footer">
          <div className="overlap">
            ...
            <div className="social-media">
              <img className="icon-circle-facebook" alt="Icon circle facebook" src="icon-circle-facebook.svg" />
              <img className="icon-circle" alt="Icon circle" src="icon-circle-instagram.svg" />
              <img className="icon-circle-youtube" alt="Icon circle youtube" src="icon-circle-youtube.svg" />
            </div>
          </div>
        </footer>
        <div className="overlap-3">
          <div className="mission">
            ...
            <div className="mission-image">
              <div className="overlap-group-3">
                ...
                <img className="removal" alt="Removal" src="removal-841-1.png" />
              </div>
            </div>
          </div>
          <div className="vision">
            ...
            <img className="img" alt="Removal" src="removal-4.png" />
          </div>
        </div>
        <div className="shops">
          <img className="sri-laka-pins" alt="Sri laka pins" src="sri-laka-pins-647x1024-1.png" />
          <div className="vroom-ville">
            <div className="overlap-4">
              <div className="overlap-5">
                <div className="open-details">
                  <div className="overlap-group-4">
                    ...
                    <div className="group-10">
                      ...
                      <img
                        className="check-perspective"
                        alt="Check perspective"
                        src="check-perspective-matte-s-1-2.png"
                      />
                      <img
                        className="check-perspective-2"
                        alt="Check perspective"
                        src="check-perspective-matte-s-2-2.png"
                      />
                      <img
                        className="check-perspective-3"
                        alt="Check perspective"
                        src="check-perspective-matte-s-3.png"
                      />
                    </div>
                  </div>
                </div>
                ...
                <img
                  className="location-perspective"
                  alt="Location perspective"
                  src="location-perspective-matte-s-1.png"
                />
              </div>
            ...
            <div className="overlap-4">
              <div className="overlap-7">
                <div className="open-details-2">
                  <div className="overlap-group-6">
                    ...
                    <div className="group-11">
                      ...
                      <img
                        className="check-perspective-4"
                        alt="Check perspective"
                        src="check-perspective-matte-s-1-3.png"
                      />
                      <img
                        className="check-perspective-5"
                        alt="Check perspective"
                        src="check-perspective-matte-s-2-3.png"
                      />
                    </div>
                  </div>
                </div>
                ...
                <img
                  className="location-perspective"
                  alt="Location perspective"
                  src="location-perspective-matte-s-3.png"
                />
                <p className="div-3">
                  <span className="text-wrapper-14">
              ...
              <div className="overlap-7">
                <div className="open-details-3">
                  <div className="overlap-group-6">
                    ...
                    <img
                      className="check-perspective-6"
                      alt="Check perspective"
                      src="check-perspective-matte-s-2.png"
                    />
                    <img
                      className="check-perspective-5"
                      alt="Check perspective"
                      src="check-perspective-matte-s-1.png"
                    />
                  </div>
                </div>
                <div className="div-2">
                ...
                <img
                  className="location-perspective"
                  alt="Location perspective"
                  src="location-perspective-matte-s-2.png"
                />
                <p className="div-3">
                  <span className="text-wrapper-14">
                    No 64, Galle Street,
        ...
        <div className="promotions">
          ...
          <img className="unsplash-lghmdc" alt="Unsplash lghmdc" src="unsplash-k7o0-lghmdc.png" />
        ...
        <div className="frame">
          <div className="vector-wrapper">
            <img className="img-2" alt="Vector" src="vector.svg" />
          </div>
          <div className="reserve-wrapper">
            <img className="img-2" alt="Reserve" src="reserve.png" />
          </div>
          <div className="place-marker-wrapper">
            <img className="img-2" alt="Place marker" src="place-marker.png" />
          </div>
          <div className="payment-history-wrapper">
            <img className="payment-history" alt="Payment history" src="payment-history.png" />
          </div>
          <div className="earth-planet-wrapper">
            <img className="img-2" alt="Earth planet" src="earth-planet.png" />
          </div>
